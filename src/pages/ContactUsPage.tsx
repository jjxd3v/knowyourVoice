        ...
        <div className="bg-white dark:bg-surface-dark p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100 dark:border-border-dark h-full">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-border-dark">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                href="https://facebook.com/glenmark.plaza"
                target="_blank"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">@glenmark.plaza</p>
                </div>
              </a>
              
              <a
                href="https://instagram.com/glenmarkplaza"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">@glenmarkplaza</p>
                </div>
              </a>
              
              <a
                href="https://github.com/glenmarkplaza"
                target="_blank"
                rel="noopener noreferrer"
